...
export default function ShareTools({ title, url, description, imageUrl }: ShareToolsProps) {
  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      ...
      {/* Dropdown - only shows on desktop (mobile uses native share) */}
      {isOpen && !canNativeShare && (
        <div 
          className="absolute right-0 md:left-0 md:right-auto top-full mt-3 z-50 min-w-[220px] bg-background border border-border shadow-lg"
          style={{
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 min-h-[48px] text-left text-xs tracking-[0.1em] uppercase text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
          >
